...
kerberos libressl lzma cpu_flags_x86_mmx nls openexr +policykit spell strigi
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-4.14.19-no-strigi.patch"
)
...
src_configure() {
	local mycmakeargs=(
		...
		$(cmake-utils_use_find_package strigi Strigi)
