...
# $Header: /var/cvsroot/gentoo-x86/kde-base/systemsettings/systemsettings-4.11.9-r1.ebuild,v 1.1 2014/05/13 17:43:05 johu Exp $
...
src_prepare() {
	# disable strigi if -nepomuk
	use !nepomuk && epatch "${FILESDIR}/${PN}-4.13.1-remove-strigi.patch"
