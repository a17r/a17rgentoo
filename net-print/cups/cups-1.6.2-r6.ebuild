...
# $Header: /var/cvsroot/gentoo-x86/net-print/cups/cups-1.6.2-r5.ebuild,v 1.13 2013/08/06 12:34:16 ago Exp $

EAPI=5

PYTHON_DEPEND="python? 2:2.5"

inherit autotools base fdo-mime gnome2-utils flag-o-matic linux-info multilib multilib-minimal pam python user versionator java-pkg-opt-2 systemd
...
RDEPEND="
	app-text/libpaper[${MULTILIB_USEDEP}]
	acl? (
		kernel_linux? (
			sys-apps/acl
	...
	ssl? (
		gnutls? (
			>=dev-libs/libgcrypt-1.5.3-r1[${MULTILIB_USEDEP}]
