...
# $Header: /var/cvsroot/gentoo-x86/app-admin/system-config-printer-common/system-config-printer-common-1.4.3.ebuild,v 1.2 2013/11/30 18:31:57 pacho Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-1.4.3-r2-split.patch
	epatch "${FILESDIR}"/${PN}-1.4.3-r2-scp-dbus-service-no-gdk.patch
	eautoreconf
}
