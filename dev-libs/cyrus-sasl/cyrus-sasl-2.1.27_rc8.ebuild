...
inherit flag-o-matic ltprune multilib-minimal autotools pam java-pkg-opt-2 db-use systemd

SASLAUTHD_CONF_VER="2.1.26"

DESCRIPTION="The Cyrus SASL (Simple Authentication and Security Layer)"
HOMEPAGE="https://www.cyrusimap.org/sasl/"
SRC_URI="ftp://ftp.cyrusimap.org/cyrus-sasl/${P/_/-}.tar.gz"
...
PATCHES=(
	...
	"${FILESDIR}/${P}-avoid_pic_overwrite.patch"
)
...
src_prepare() {
	...
	sed -e '/^sasldir =/s:=.*:= $(plugindir):' \
		-i plugins/Makefile.{am,in} || die "sed failed"

	# #486740 #468556
	sed -e 's:AC_CONFIG_MACRO_DIR:AC_CONFIG_MACRO_DIRS:g' \
		-i configure.ac || die
...
multilib_src_configure() {
	...
	use urandom && myconf+=( --with-devrandom=/dev/urandom )
...
multilib_src_install_all() {
	...
	local DOCS=( AUTHORS ChangeLog README saslauthd/LDAP_SASLAUTHD )
