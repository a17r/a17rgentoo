...
RDEPEND="
	...
	~dev-qt/qtdeclarative-${QT5_MINIMAL}
	~dev-qt/qtgui-${QT5_MINIMAL}
	~dev-qt/qtnetwork-${QT5_MINIMAL}
	...
	x11-libs/libXtst
	geolocation? ( ~dev-qt/qtpositioning-${QT5_MINIMAL} )
	system-ffmpeg? ( media-video/ffmpeg:0= )
	system-icu? ( dev-libs/icu:= )
	widgets? ( ~dev-qt/qtwidgets-${QT5_MINIMAL} )
"
DEPEND="${RDEPEND}
	${PYTHON_DEPS}
	dev-util/gperf
