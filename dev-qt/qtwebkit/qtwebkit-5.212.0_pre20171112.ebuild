...
inherit check-reqs cmake-utils flag-o-matic python-any-r1 qmake-utils ruby-single toolchain-funcs vcs-snapshot

DESCRIPTION="Open source web browser engine"
HOMEPAGE="https://www.qt.io/"
# SRC_URI="https://github.com/annulen/webkit/releases/download/${P/_/-}/${P/_/-}.tar.xz"
SRC_URI="https://github.com/annulen/webkit/archive/${COMMIT}.tar.gz -> ${P}.tar.gz"
