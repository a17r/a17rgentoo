...
src_configure() {
	...
	econf \
		...
		$(use_enable nls) \
		$(use_enable qt5) \
		--with-qt-dir=$(usex qt5 $(qt5_get_libdir) $(qt4_get_libdir)) \
		ac_cv_path_QT_MOC=$(usex qt5 $(qt5_get_bindir)/moc $(qt4_get_bindir)/moc) \
		ac_cv_path_QT_RCC=$(usex qt5 $(qt5_get_bindir)/rcc $(qt4_get_bindir)/rcc) \
		ac_cv_path_QT_UIC=$(usex qt5 $(qt5_get_bindir)/uic $(qt4_get_bindir)/uic) \
