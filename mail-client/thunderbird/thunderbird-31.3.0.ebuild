...
# $Header: /var/cvsroot/gentoo-x86/mail-client/thunderbird/thunderbird-31.3.0.ebuild,v 1.4 2014/12/10 19:34:41 ago Exp $
...
IUSE="bindist crypt kde ldap +lightning +minimal mozdom selinux"
...
src_prepare() {
	...
	if use kde; then
		rm -f mozilla/browser/components/shell/src/nsKDEShellService.cpp \
			mozilla/browser/components/shell/src/nsKDEShellService.h \
			mozilla/browser/components/shell/src/nsUnixShellService.cpp \
			mozilla/browser/components/shell/src/nsUnixShellService.h \
			mozilla/browser/base/content/browser-kde.xul || die
		rm -f mozilla/toolkit/xre/nsKDEUtils.cpp \
			mozilla/toolkit/xre/nsKDEUtils.h \
			mozilla/uriloader/exthandler/unix/nsCommonRegistry.cpp \
			mozilla/uriloader/exthandler/unix/nsCommonRegistry.h \
			mozilla/uriloader/exthandler/unix/nsKDERegistry.cpp \
			mozilla/uriloader/exthandler/unix/nsKDERegistry.h \
			mozilla/toolkit/content/widgets/dialog-kde.xml \
			mozilla/toolkit/content/widgets/preferences-kde.xml || die

		install -m 644 "${FILESDIR}/kde.js" mozilla/browser/app/profile/kde.js

		# patches taken from http://www.rosenauer.org/hg/mozilla
		epatch "${FILESDIR}"/${PN}-31.3-mozilla-kde.patch
		epatch "${FILESDIR}"/${PN}-31.3-kde.patch
	fi
